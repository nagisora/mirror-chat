...
(function () {
  ...
  window.MirrorChatUtils.htmlToMarkdown = htmlToMarkdown;
  window.MirrorChatUtils.waitFor = waitFor;
  window.MirrorChatUtils.waitForStable = waitForStable;
  window.MirrorChatUtils.waitForResponseComplete = waitForResponseComplete;
})();
