(function () {
  chrome.runtime.onMessage.addListener((msg, _sender, sendResponse) => {
    ...
    const inputSel = cfg.inputSelector || "textarea[data-id='root'], textarea";
    const submitSel = cfg.submitButtonSelector || "button[data-testid='send-button'], button[data-testid='send']";
    const answerSel = cfg.answerContainerSelector || "main [data-testid='conversation-turns'], main";
    ...
    (async () => {
      try {
        ...
        if (waitForStable) {
          await waitForStable(answerSel, 3000);
        } else {
